...
const { registerController, loginController, refreshController, logoutController, } = await import("./auth.controller.js");
const mockResponse = () => {
    const res = {};
...
describe("Auth Controller", () => {
    ...
    describe("registerController", () => {
        it("should register user successfully", async () => {
            ...
            jest.mocked(authService.registerUser).mockResolvedValue(mockUser);
    ...
    describe("loginController", () => {
        it("should login user successfully and set refresh token cookie", async () => {
            ...
            jest.mocked(authService.loginUser).mockResolvedValue(mockResult);
